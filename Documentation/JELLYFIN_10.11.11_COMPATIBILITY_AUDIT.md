...
| Section names | Uses Jellyfin-style text section headings without turning the heading into a first-item image or backdrop banner. Lazy authenticated image loading remains limited to media artwork. | Version-pinned Jellyfin Web heading classes plus plugin-owned presentation. |
